...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=ROOT / "ballwooden/ballwooden model/yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "ballwooden/ballwooden parameter/coco128.yaml", help="dataset.yaml path")
